...
public class Practice {
    @NotNull
    private static final String scriptFolder = "practices/";
    private final long id;
    @NotNull
    private String name;

    private Practice(long id, @NotNull String name) {
        this.id = id;
        this.name = name;
    }

    public Practice(@NotNull ResultSet rs) throws SQLException {
        this(rs.getLong("practices.id"), rs.getString("practices.name"));
    }

    public Practice(long id) throws SQLException {
    ...
    public Practice(@NotNull String name) throws SQLException {
