...
public class Medicine {
    @NotNull
    private static final String scriptFolder = "medicines/";
    private final long id;
    @NotNull
    private String name;

    private Medicine(long id, @NotNull String name) {
        this.id = id;
        this.name = name;
    }

    public Medicine(@NotNull ResultSet rs) throws SQLException {
        this(rs.getLong("medicines.id"), rs.getString("medicines.name"));
    }

    public Medicine(long id) throws SQLException {
    ...
    public Medicine(@NotNull String name) throws SQLException {
    ...
    public static List<Medicine> list() throws SQLException {
