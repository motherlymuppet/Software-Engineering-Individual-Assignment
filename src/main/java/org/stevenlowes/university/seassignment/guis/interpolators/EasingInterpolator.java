...
public abstract class EasingInterpolator extends Interpolator {
    ...
    //http://myjavafx.blogspot.co.uk/2013/08/beef-up-your-animations-with-easing.html
    ...
    /**
     * Defines the base curve for the interpolator. The base curve is then transformed into an easing-in, easing-out easing-both curve.
     *
